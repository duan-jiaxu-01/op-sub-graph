...
export class ProposalDeadlineUpdated extends ethereum.Event {
  get params(): ProposalDeadlineUpdated__Params {
    return new ProposalDeadlineUpdated__Params(this);
  }
}

export class ProposalDeadlineUpdated__Params {
  _event: ProposalDeadlineUpdated;

  constructor(event: ProposalDeadlineUpdated) {
    this._event = event;
  }
...
export class OptimismGovernorV5__proposalVotesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class OptimismGovernorV5 extends ethereum.SmartContract {
  static bind(address: Address): OptimismGovernorV5 {
    return new OptimismGovernorV5("OptimismGovernorV5", address);
  }
  ...
  cancelWithModule(
    ...
    let result = super.call(
      "cancelWithModule",
      "cancelWithModule(address,bytes,bytes32):(uint256)",
      [
  ...
  hashProposalWithData(
    ...
    let result = super.call(
      "hashProposalWithData",
      "hashProposalWithData(address,bytes,bytes32):(uint256)",
      [
        ethereum.Value.fromAddress(module),
        ethereum.Value.fromBytes(proposalData),
        ethereum.Value.fromFixedBytes(descriptionHash)
  ...
  proposalVotes(proposalId: BigInt): OptimismGovernorV5__proposalVotesResult {
    let result = super.call(
      "proposalVotes",
    ...
    return new OptimismGovernorV5__proposalVotesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_proposalVotes(
    proposalId: BigInt
  ): ethereum.CallResult<OptimismGovernorV5__proposalVotesResult> {
    let result = super.tryCall(
      "proposalVotes",
      "proposalVotes(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      new OptimismGovernorV5__proposalVotesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  proposeWithModule(
    ...
    let result = super.call(
      "proposeWithModule",
      "proposeWithModule(address,bytes,string):(uint256)",
      [
        ethereum.Value.fromAddress(module),
        ethereum.Value.fromBytes(proposalData),
        ethereum.Value.fromString(description)
...
export class CancelWithModuleCall extends ethereum.Call {
  get inputs(): CancelWithModuleCall__Inputs {
    return new CancelWithModuleCall__Inputs(this);
  }

  get outputs(): CancelWithModuleCall__Outputs {
    return new CancelWithModuleCall__Outputs(this);
  }
}

export class CancelWithModuleCall__Inputs {
  _call: CancelWithModuleCall;

  constructor(call: CancelWithModuleCall) {
    this._call = call;
  }
...
export class CancelWithModuleCall__Outputs {
  _call: CancelWithModuleCall;
...
export class ExecuteWithModuleCall extends ethereum.Call {
  get inputs(): ExecuteWithModuleCall__Inputs {
    return new ExecuteWithModuleCall__Inputs(this);
  }

  get outputs(): ExecuteWithModuleCall__Outputs {
    return new ExecuteWithModuleCall__Outputs(this);
  }
}

export class ExecuteWithModuleCall__Inputs {
  _call: ExecuteWithModuleCall;

  constructor(call: ExecuteWithModuleCall) {
    this._call = call;
  }
...
export class ExecuteWithModuleCall__Outputs {
  _call: ExecuteWithModuleCall;
...
export class ProposeWithModuleCall extends ethereum.Call {
  get inputs(): ProposeWithModuleCall__Inputs {
    return new ProposeWithModuleCall__Inputs(this);
  }

  get outputs(): ProposeWithModuleCall__Outputs {
    return new ProposeWithModuleCall__Outputs(this);
  }
}

export class ProposeWithModuleCall__Inputs {
  _call: ProposeWithModuleCall;

  constructor(call: ProposeWithModuleCall) {
    this._call = call;
  }
...
export class ProposeWithModuleCall__Outputs {
  _call: ProposeWithModuleCall;
...
export class SetProposalDeadlineCall extends ethereum.Call {
  get inputs(): SetProposalDeadlineCall__Inputs {
    return new SetProposalDeadlineCall__Inputs(this);
  }

  get outputs(): SetProposalDeadlineCall__Outputs {
    return new SetProposalDeadlineCall__Outputs(this);
  }
}

export class SetProposalDeadlineCall__Inputs {
  _call: SetProposalDeadlineCall;

  constructor(call: SetProposalDeadlineCall) {
    this._call = call;
  }
...
export class SetProposalDeadlineCall__Outputs {
  _call: SetProposalDeadlineCall;
